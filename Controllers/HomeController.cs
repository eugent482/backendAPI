...
namespace BackEnd.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpGet]
        public ContentResult FillTable()
        {
            string json = "";

            ProductService service = new ProductService();

            List<ModalViewProducts> products = service.GetRowsBySearch("", 10, 1);
            double num = Math.Ceiling((double)service.GetNumOfRows("")/10);
        ...
        [HttpPost]
        public ContentResult FillTable(string search,int num,int page)
        {
            string json = "";
        ...
        [HttpPost]
        public ActionResult PostTest(int id)
        {
